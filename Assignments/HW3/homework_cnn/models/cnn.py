...
class CNN(object):
    ...
    def __init__(
        ...
        for i in range(self.nlayers):
            conv = Conv1d(in_channels=in_ch, out_channels=num_channels[i],
                          kernel_size=kernel_sizes[i], stride=strides[i], padding=0,
        ...
        self.linear_layer.W = linear_weight_init_fn(num_linear_neurons, num_channels[-1] * output_width)
